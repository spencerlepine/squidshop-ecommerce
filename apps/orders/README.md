...
Orders API microservice to store and magange customer purchases. Connected to relational PostgreSQL database. Uses continuous integration to lint, test, and build with `GitHub Actions`.
